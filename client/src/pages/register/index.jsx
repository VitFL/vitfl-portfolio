      ...
      <Row className="h-100">
        <Col sm={{ size: 6, offset: 3 }} md={{ size: 4, offset: 4 }} className="m-auto">
          <Container>
            ...
            <Row className="py-4">
              <Col><StyledHeader>SIGN UP</StyledHeader></Col>
            </Row>
            <Row className="py-1">
            ...
            <Row className="py-1">
              <Col><Input name="password2" type="password" placeholder="Repeat Password" onChange={e => setFormData({ ...formData, password2: e.target.value })} /></Col>
            </Row>
            <Row className="py-1">
              <Col sm={{ size: 6, offset: 3 }} md={{ size: 4, offset: 4 }} className="m-auto">
                <Button color="outline-accent" className="text-uppercase" size="sm">Sign Up</Button>
              </Col>
            </Row>
          </Container>
        </Col>
